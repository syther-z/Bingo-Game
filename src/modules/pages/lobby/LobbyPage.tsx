...
const LobbyPage = () => {
  ...
  return (
    <div className="w-screen h-screen bg-(--homepage-color) p-5 flex flex-col gap-5 items-center">
      ...
      <div className="max-w-[600px] h-[60px] w-full rounded-[12px] bg-[#ecf1f2] mt-6 flex shadow-[0_10px_0px_0px_#414141] overflow-hidden">
        <div
      ...
      <div className="max-w-[700px] w-full rounded-[12px] border border-[#3a3a3a] bg-[#1f1f1f] p-4 shadow-[0_10px_0px_0px_#1a1a1a]">
